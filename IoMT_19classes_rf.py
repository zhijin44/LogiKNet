...
scaler_save_path = 'CIC_IoMT/19classes/scaler_rf.joblib'
dump(scaler, scaler_save_path)
print("Data scaled.")

# Check if the model already exists
model_save_path = 'CIC_IoMT/19classes/random_forest_model.joblib'
if os.path.exists(model_save_path):
    ...
    model = RandomForestClassifier(n_estimators=100, random_state=1, verbose=2)
